# AIIMS Mangalagiri MCP Server

This MCP (Model Content Protocol) server provides access to AIIMS Mangalagiri API functionality through HTTP, HTTPS, and STDIO transport modes.
